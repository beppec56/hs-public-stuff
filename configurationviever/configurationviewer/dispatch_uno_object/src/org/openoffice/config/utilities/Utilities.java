...
public class Utilities {
	...
	public static void showServiceProperties(XInterface oObj) {
		...
		if (xPropSet == null)
			...
			showProperties(xPropSet);
	}

	public static void showProperties(XPropertySet xPropSet) {
		XPropertySetInfo xPInfo = xPropSet.getPropertySetInfo();
		if (xPInfo != null) {
			...
			for (i = 0; i < allProp.length; i++) {
				System.out.print(i + " : " + allProp[i].Name + ",   " + allProp[i].Type);
				Utilities.showProperty(xPropSet, allProp[i].Name);
			}
		} else {
			System.out.println(" No property set available!");
		}
	}
	 ...
	 *        output.
	 */
	public static void showServices(XInterface xObject) {
		try {
			// sMsgArea.println ("Services:");
	 ...
	 */
	public static void showInterfaces(XInterface xObject) {
		try {
			...
			if (xTP == null)
				System.out.println("    interface XTypeProvider not supported");
			else {
				Type[] aTypeList = xTP.getTypes();
				System.out.println("    object supports " + aTypeList.length
						+ " interfaces");
	 ...
	 * @descr Print information about supported interfaces.
	 */
	public static void showInterfaces(Object xObject) {
		showInterfaces((XInterface) xObject);
	}
